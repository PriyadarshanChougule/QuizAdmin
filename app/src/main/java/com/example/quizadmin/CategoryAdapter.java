...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    private List<CaregoryModel> cat_list;


    public CategoryAdapter(List<CaregoryModel> cat_list) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void deleteCategory(final int id, Context context,final CategoryAdapter adapter){
            loadingDialog.show();
